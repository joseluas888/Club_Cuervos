//
//  PlantillaFichaCobradaView.swift
//  ManagerCaritas
//
...
struct FichaExpandidaCobradaView: View {
...
struct FichaEncogidaCobradaView: View {
    @Binding var push:Bool
...
struct PlantillaFichaCobradaView: View {
    ...
    var body: some View {
        ZStack {
            if !push {
                FichaEncogidaCobradaView(push: $push, direccion: self.direccion, nombre: self.nombre, folio: self.folio, cantidad: self.cantidad, recibido: self.recibido)
            }
            if push {
                FichaExpandidaCobradaView(push: $push, direccion: self.direccion, nombre: self.nombre, folio: self.folio, cantidad: self.cantidad, comentario: self.comentario, telFijo: self.telFijo, telExtra: self.telExtra, telCelular: self.telCelular, recibido: self.recibido)
            }
        }
    }
}

struct PlantillaFichaCobradaView_Previews: PreviewProvider {
    static var previews: some View {
        PlantillaFichaCobradaView()
    }
}
